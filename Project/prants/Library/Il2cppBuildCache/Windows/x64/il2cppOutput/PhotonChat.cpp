...
IL_0030:
	{
		...
		NullCheck(L_5);
		uint8_t L_6;
		L_6 = PhotonPeer_get_PeerState_mE3864AAB7C37F282783A02594C8346595B2245FA(L_5, /*hidden argument*/NULL);
		V_0 = L_6;
		RuntimeObject * L_7 = Box(PeerStateValue_t7EF989C9EA41DC898E1B1F9E0604E305CDE1D4D4_il2cpp_TypeInfo_var, (&V_0));
		NullCheck(L_7);
		String_t* L_8;
...
IL_0095:
	...
	}
	{
		...
		uint8_t L_18;
		L_18 = SupportClass_StartBackgroundCalls_m6D4F8B9DDC0B482A11320CCEB2AD36E3DCB7DCEB(L_16, L_17, _stringLiteralDF6A7CB87243568376528ACED2E19B84FDCE6A7C, /*hidden argument*/NULL);
		G_B6_0 = G_B5_0;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool ChatClient_Subscribe_m46616D5803D260E29FFEB498412279142076F3E8 (ChatClient_t5E3E39382FC13DF25585EFE46374B01B3BC377DF * __this, StringU5BU5D_tACEBFEDE350025B554CD507C9AE8FFE49359549A* ___channels0, Int32U5BU5D_t70F1BDC14B1786481B176D6139A5E3B87DC54C32* ___lastMsgIds1, const RuntimeMethod* method)
{
	...
	}
	{
		...
		uint8_t L_1;
		L_1 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL_004b:
	...
	}
	{
		// if (this.DebugOut >= DebugLevel.ERROR)
		uint8_t L_12;
		L_12 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL_002f:
	{
		// if (this.DebugOut >= DebugLevel.WARNING)
		uint8_t L_6;
		L_6 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL_001b:
	...
	{
		uint8_t L_7;
		L_7 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL_0059:
	...
	}
	{
		...
		NullCheck(L_4);
		bool L_5;
		L_5 = PhotonPeer_EstablishEncryption_mC17C2FCC0E10F5C2E0A6E90F089D3DC5EEF0C649(L_4, /*hidden argument*/NULL);
		if (L_5)
		{
			goto IL_0095;
		}
...
IL_0103:
	...
	}
	{
		...
		NullCheck(L_25);
		uint8_t L_26;
		L_26 = PhotonPeer_get_TransportProtocol_mCDF9096B2B24C0DA40C9B9651748C6BBD49A1C36_inline(L_25, /*hidden argument*/NULL);
		G_B19_0 = L_24;
...
IL_0168:
	{
		...
		NullCheck(L_36);
		String_t* L_37;
		L_37 = PhotonPeer_get_ServerAddress_mE5D86C41A5E4DB8AE0BFEAFCEE8D7BD32A7B795A(L_36, /*hidden argument*/NULL);
		String_t* L_38 = V_0;
		String_t* L_39;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ChatClient_HandlePrivateMessageEvent_m8813795A2221F5BF3E0B20B403743F8C5F070922 (ChatClient_t5E3E39382FC13DF25585EFE46374B01B3BC377DF * __this, EventData_t871296A1729578EA10106122CFB9866E0C812FED * ___eventData0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_14);
		RuntimeObject * L_15;
		L_15 = ParameterDictionary_get_Item_mFE6788221B83E9B532F482B156022D2C64C783AD(L_14, (uint8_t)((int32_t)225), /*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ChatClient_HandleChatMessagesEvent_mCA5FE5D7298F4A44DD0652A417346C7080DE34CF (ChatClient_t5E3E39382FC13DF25585EFE46374B01B3BC377DF * __this, EventData_t871296A1729578EA10106122CFB9866E0C812FED * ___eventData0, const RuntimeMethod* method)
{
	...
	}
	{
		// if (this.DebugOut >= DebugLevel.WARNING)
		uint8_t L_15;
		L_15 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL_0071:
	{
		...
		NullCheck(L_26);
		bool L_27;
		L_27 = ParameterDictionary_TryGetValue_m1E3BB73C8878898C618C575DD60395A0A21D455D(L_26, (uint8_t)((int32_t)22), (RuntimeObject **)(&V_5), /*hidden argument*/NULL);
		if (!L_27)
		{
			goto IL_0094;
		}
...
IL_00b0:
	{
		...
		EventData_t871296A1729578EA10106122CFB9866E0C812FED * L_37 = ___eventData0;
		NullCheck(L_37);
		ParameterDictionary_tC9170F3454C91BDD4DF51AEA14C1B3B10F846B6A * L_38 = L_37->get_Parameters_1();
		NullCheck(L_38);
		bool L_39;
		L_39 = ParameterDictionary_TryGetValue_m1E3BB73C8878898C618C575DD60395A0A21D455D(L_38, (uint8_t)((int32_t)23), (RuntimeObject **)(&V_5), /*hidden argument*/NULL);
		if (!L_39)
		{
			goto IL_00d3;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ChatClient_HandleAuthResponse_m14F815DA58282B95B2CA8514296A999E2E31E8F9 (ChatClient_t5E3E39382FC13DF25585EFE46374B01B3BC377DF * __this, OperationResponse_t710E93CBE101D2F5A98B4E29CE0B8F77AB400089 * ___operationResponse0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_2);
		String_t* L_3;
		L_3 = OperationResponse_ToStringFull_m0D18931F67DF9662EA85FA74D16E584DC6225551(L_2, /*hidden argument*/NULL);
		ChatPeer_t183F524D188B12FB814FB129C4C454478C42158F * L_4 = __this->get_chatPeer_18();
		NullCheck(L_4);
		String_t* L_5;
...
IL_0030:
	...
	}
	{
		...
		NullCheck(L_13);
		bool L_14;
		L_14 = ParameterDictionary_ContainsKey_m6FF8FC0A74B7D530B5BA98CB06497FB86E918F48(L_13, (uint8_t)((int32_t)221), /*hidden argument*/NULL);
		if (!L_14)
		{
			goto IL_00c2;
		}
...
IL_0084:
	{
		...
		NullCheck(L_18);
		RuntimeObject * L_19;
		L_19 = OperationResponse_get_Item_m68A608931C066775A207374BE2522B7B0010AC87(L_18, (uint8_t)((int32_t)221), /*hidden argument*/NULL);
		NullCheck(L_17);
		...
		NullCheck(L_20);
		RuntimeObject * L_21;
		L_21 = OperationResponse_get_Item_m68A608931C066775A207374BE2522B7B0010AC87(L_20, (uint8_t)((int32_t)230), /*hidden argument*/NULL);
...
IL_00c2:
	{
		// if (this.DebugOut >= DebugLevel.ERROR)
		uint8_t L_23;
		L_23 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL_00dc:
	{
		...
		NullCheck(L_26);
		bool L_27;
		L_27 = ParameterDictionary_ContainsKey_m6FF8FC0A74B7D530B5BA98CB06497FB86E918F48(L_26, (uint8_t)((int32_t)225), /*hidden argument*/NULL);
		if (!L_27)
		{
			goto IL_024d;
		}
	}
	{
		...
		NullCheck(L_29);
		RuntimeObject * L_30;
		L_30 = ParameterDictionary_get_Item_mFE6788221B83E9B532F482B156022D2C64C783AD(L_29, (uint8_t)((int32_t)225), /*hidden argument*/NULL);
...
IL_019a:
	{
		...
		OperationResponse_t710E93CBE101D2F5A98B4E29CE0B8F77AB400089 * L_48 = ___operationResponse0;
		NullCheck(L_48);
...
IL_0206:
	{
		// if (this.DebugOut >= DebugLevel.ERROR)
		uint8_t L_53;
		L_53 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
	...
	}
	{
		...
		OperationResponse_t710E93CBE101D2F5A98B4E29CE0B8F77AB400089 * L_55 = ___operationResponse0;
		NullCheck(L_55);
		String_t* L_56;
		L_56 = OperationResponse_ToStringFull_m0D18931F67DF9662EA85FA74D16E584DC6225551(L_55, /*hidden argument*/NULL);
		int32_t L_57;
		...
		NullCheck(L_60);
		String_t* L_61;
		L_61 = PhotonPeer_get_ServerAddress_mE5D86C41A5E4DB8AE0BFEAFCEE8D7BD32A7B795A(L_60, /*hidden argument*/NULL);
		String_t* L_62;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ChatClient_HandleStatusUpdate_m6A2E14725C9C41CC8C0DD645D899E1FA3FACE040 (ChatClient_t5E3E39382FC13DF25585EFE46374B01B3BC377DF * __this, EventData_t871296A1729578EA10106122CFB9866E0C812FED * ___eventData0, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_11);
		RuntimeObject * L_12;
		L_12 = ParameterDictionary_get_Item_mFE6788221B83E9B532F482B156022D2C64C783AD(L_11, (uint8_t)3, /*hidden argument*/NULL);
		V_2 = L_12;
	}
...
IL_002c:
	{
		...
		NullCheck(L_4);
		bool L_6;
		L_6 = VirtFuncInvoker3< bool, String_t*, String_t*, RuntimeObject * >::Invoke(6 /* System.Boolean ExitGames.Client.Photon.PhotonPeer::Connect(System.String,System.String,System.Object) */, L_4, L_5, _stringLiteral73442709295E0907BAB5FF689567842B1B7D4C01, NULL);
		if (L_6)
		{
			goto IL_006c;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool ChatClient_AuthenticateOnFrontEnd_m4E005CD5611CE63F801F714BC5FF3282B9A06002 (ChatClient_t5E3E39382FC13DF25585EFE46374B01B3BC377DF * __this, const RuntimeMethod* method)
{
	...
	}
	{
		// if (this.DebugOut >= DebugLevel.ERROR)
		uint8_t L_3;
		L_3 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL_0080:
	{
		// if (this.DebugOut >= DebugLevel.ERROR)
		uint8_t L_18;
		L_18 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void ChatClient_HandleUserUnsubscribedEvent_mC1A03A9D9606364F22A156EC14616D214E901041 (ChatClient_t5E3E39382FC13DF25585EFE46374B01B3BC377DF * __this, EventData_t871296A1729578EA10106122CFB9866E0C812FED * ___eventData0, const RuntimeMethod* method)
{
	...
	}
	{
		// if (this.DebugOut >= DebugLevel.WARNING)
		uint8_t L_11;
		L_11 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL_0061:
	...
	}
	{
		// if (this.DebugOut >= DebugLevel.WARNING)
		uint8_t L_20;
		L_20 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL_00f1:
	{
		// if (this.DebugOut >= DebugLevel.WARNING)
		uint8_t L_45;
		L_45 = ChatClient_get_DebugOut_mA44EC91923BABA545FCAFE1AD9185D011441DA80(__this, /*hidden argument*/NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* ChatPeer_GetNameServerAddress_mEAAD5D9ACA62B947FBBB028C44C9E6358715FC8E (ChatPeer_t183F524D188B12FB814FB129C4C454478C42158F * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		RuntimeObject* L_4;
		L_4 = PhotonPeer_get_Listener_m8536854BA7BA67DDF0C224D01CA36DB755615E82_inline(__this, /*hidden argument*/NULL);
		uint16_t L_5 = __this->get_NameServerPortOverride_61();
		uint16_t L_6 = L_5;
		...
		NullCheck(L_4);
		InterfaceActionInvoker2< uint8_t, String_t* >::Invoke(0 /* System.Void ExitGames.Client.Photon.IPhotonPeerListener::DebugReturn(ExitGames.Client.Photon.DebugLevel,System.String) */, IPhotonPeerListener_t804B13EBE00367D7163725D1181D1B33437CB5DE_il2cpp_TypeInfo_var, L_4, 3, L_8);
		// protocolPort = this.NameServerPortOverride;
		uint16_t L_9 = __this->get_NameServerPortOverride_61();
		V_0 = L_9;
	}
...
IL_0045:
	{
		...
		uint8_t L_10;
		L_10 = PhotonPeer_get_TransportProtocol_mCDF9096B2B24C0DA40C9B9651748C6BBD49A1C36_inline(__this, /*hidden argument*/NULL);
		V_1 = L_10;
		uint8_t L_11 = V_1;
		switch (L_11)
		{
...
IL_006c:
	{
		...
		String_t* L_12 = __this->get_NameServerHost_59();
		int32_t L_13 = V_0;
		int32_t L_14 = L_13;
...
IL_0083:
	{
		...
		String_t* L_17 = __this->get_NameServerHost_59();
		int32_t L_18 = V_0;
		int32_t L_19 = L_18;
...
IL_009a:
	{
		...
		String_t* L_22 = __this->get_NameServerHost_59();
		int32_t L_23 = V_0;
		int32_t L_24 = L_23;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool ChatPeer_Connect_m0560376B05909F8A69353708FF0B150D5EB85D7F (ChatPeer_t183F524D188B12FB814FB129C4C454478C42158F * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		RuntimeObject* L_1;
		L_1 = PhotonPeer_get_Listener_m8536854BA7BA67DDF0C224D01CA36DB755615E82_inline(__this, /*hidden argument*/NULL);
		String_t* L_2;
...
IL_0025:
	{
		...
		bool L_5;
		L_5 = VirtFuncInvoker3< bool, String_t*, String_t*, RuntimeObject * >::Invoke(6 /* System.Boolean ExitGames.Client.Photon.PhotonPeer::Connect(System.String,System.String,System.Object) */, __this, L_4, _stringLiteral84F3409D006A485853CE590C6F1C4AA00ABCA26F, NULL);
		return L_5;
	}
}
// System.Boolean Photon.Chat.ChatPeer::AuthenticateOnNameServer(System.String,System.String,System.String,Photon.Chat.AuthenticationValues)
...
IL_00e8:
	{
		...
		bool L_40;
		L_40 = PhotonPeer_get_IsEncryptionAvailable_m3AEBF9DB21964B2E0CDD93F48C20DCFEA90D83F7(__this, /*hidden argument*/NULL);
